      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-body">
              <table id="table_realisasi_up" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                    ...
                    <tbody>
                      <?php foreach($load_all_realisasi_up as $up):?>
                        <tr>
                          ...
                          <td><?=strtoupper($up['cara_tarik'])?></td>
                          <td class="text-center"><?=($up['is_kontraktual'] ? 'Iya' : 'Tidak')?></td>
                          <td><?=$up['nomor_spm']?></td>
                        </tr>
                      <?php endforeach;?>
                    </tbody>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <!-- SELECT2 EXAMPLE -->
                ...
                <div class="card card-default shadow ">
                  <div class="card-header">
                    <h4 class="card-title">Input Data Realisasi UP</h4>
                  </div>
                  <form method="POST" action="<?=base_url('index.php/dashboard/simpan_realisasi')?>">
                    ...
                    <input type="hidden" name="cara_tarik" value="up">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
