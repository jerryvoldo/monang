          ...
          <div class="col-md-12">
            ...
            <div class="card-body">
              <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#ls" role="tab" aria-controls="home" aria-selected="true">Berkas LS</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="profile-tab" data-toggle="tab" href="#up" role="tab" aria-controls="profile" aria-selected="false">Berkas UP</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="contact-tab" data-toggle="tab" href="#tup" role="tab" aria-controls="contact" aria-selected="false">Berkas TUP</a>
                </li>
              </ul>
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="ls" role="tabpanel" aria-labelledby="home-tab">
                  <!-- tabel berkas LS -->
                    <table id="table_ls" class="table table-bordered table-sm">
                      <thead>
                      <tr>
                      ...
                      <tbody>
                        <?php foreach($berkas_ls as $ls):?>
                          <tr>
                            <td><?=$ls['nomor_kuitansi']?></td>
                            <td><?=date('d M Y', $ls['epoch_kuitansi'])?></td>
                            <td><?=$ls['uraian_realisasi']?></td>
                            <td class="text-center" style="font-size: 0.9em;"><?=$ls['kegiatan']?>.<?=$ls['kro']?>.<?=$ls['ro']?>.<?=$ls['komponen']?>.<?=$ls['subkomponen']?>.<?=$ls['akun']?></td>
                            <td class="text-right"><?=number_format($ls['jumlah_realisasi_bruto'])?></td>
                            <td class="text-center">
                              <?php if($ls['cara_tarik'] == 'ls'):?>
                              <h5><span class="badge badge-pill badge-info"><?=strtoupper($ls['cara_tarik'])?></span></h5>
                              <?php elseif($ls['cara_tarik'] == 'up'):?>
                                <h5><span class="badge badge-pill badge-secondary"><?=strtoupper($ls['cara_tarik'])?></span></h5>
                              <?php elseif($ls['cara_tarik'] == 'tup'):?>
                                <h5><span class="badge badge-pill badge-dark"><?=strtoupper($ls['cara_tarik'])?></span></h5>
                              <?php endif;?>
                            </td>
                            <td class="text-center">
                              <?php if($ls['sumber'] == 'rm'):?>
                ...
                <div class="tab-pane fade" id="up" role="tabpanel" aria-labelledby="profile-tab">
                   <!-- tabel berkas UP -->
                    <table id="table_up" class="table table-bordered table-sm">
                      <thead>
                      <tr>
                        <th>Nomor Kuitansi</th>
                        <th>Tanggal Kuitansi</th>
                      ...
                      <tbody>
                        <?php foreach($berkas_up as $up):?>
                          <tr>
                            <td><?=$up['nomor_kuitansi']?></td>
                            <td><?=date('d M Y', $up['epoch_kuitansi'])?></td>
                            <td><?=$up['uraian_realisasi']?></td>
                            <td class="text-center" style="font-size: 0.9em;"><?=$up['kegiatan']?>.<?=$up['kro']?>.<?=$up['ro']?>.<?=$up['komponen']?>.<?=$up['subkomponen']?>.<?=$up['akun']?></td>
                            ...
                            <td class="text-center">
                              <?php if($up['cara_tarik'] == 'ls'):?>
                              <h5><span class="badge badge-pill badge-info"><?=strtoupper($up['cara_tarik'])?></span></h5>
                              <?php elseif($up['cara_tarik'] == 'up'):?>
                                <h5><span class="badge badge-pill badge-secondary"><?=strtoupper($up['cara_tarik'])?></span></h5>
                              <?php elseif($up['cara_tarik'] == 'tup'):?>
                                <h5><span class="badge badge-pill badge-dark"><?=strtoupper($up['cara_tarik'])?></span></h5>
                              <?php endif;?>
                            </td>
                            <td class="text-center">
                              <?php if($up['sumber'] == 'rm'):?>
                            ...
                            <td class="text-center">
                              <?php if(empty($up['nomor_spm'])):?>
                                <h5><span class="badge badge-pill badge-warning">BELUM ADA</span></h5>
                              <?php else:?>
                ...
                <div class="tab-pane fade" id="tup" role="tabpanel" aria-labelledby="contact-tab">
                  <!-- tabel berkas TUP -->
                    <table id="table_tup" class="table table-bordered table-striped">
                      <thead>
                      <tr>
                        <th>Nomor Kuitansi</th>
                        <th>Tanggal Kuitansi</th>
                      ...
                      <tbody>
                        <?php foreach($berkas_tup as $tup):?>
                          <tr>
                            <td><?=$tup['nomor_kuitansi']?></td>
                            <td><?=date('d M Y', $tup['epoch_kuitansi'])?></td>
                            <td><?=$tup['uraian_realisasi']?></td>
                            <td class="text-center" style="font-size: 0.9em;"><?=$tup['kegiatan']?>.<?=$tup['kro']?>.<?=$tup['ro']?>.<?=$tup['komponen']?>.<?=$tup['subkomponen']?>.<?=$tup['akun']?></td>
                            ...
                            <td class="text-center">
                              <?php if($tup['cara_tarik'] == 'ls'):?>
                              <h5><span class="badge badge-pill badge-info"><?=strtoupper($tup['cara_tarik'])?></span></h5>
                              <?php elseif($tup['cara_tarik'] == 'up'):?>
                                <h5><span class="badge badge-pill badge-secondary"><?=strtoupper($tup['cara_tarik'])?></span></h5>
                              <?php elseif($tup['cara_tarik'] == 'tup'):?>
                                <h5><span class="badge badge-pill badge-dark"><?=strtoupper($tup['cara_tarik'])?></span></h5>
                              <?php endif;?>
                            </td>
                            <td class="text-center">
