          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo lang('create_user_subheading');?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <form method="POST" action="<?=base_url('index.php/auth/create_user')?>">
                ...
                <button class="btn btn-primary" type="submit"><?=lang('create_user_submit_btn')?></button>
                </form>
              </div>
              <!-- /.card-body -->
            </div>
