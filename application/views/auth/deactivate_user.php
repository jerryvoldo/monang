          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo sprintf(lang('deactivate_subheading'), $user->{$identity}); ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <button class="btn btn-primary" type="submit"><?=lang('deactivate_submit_btn')?></button>
                </form>
              </div>
              <!-- /.card-body -->
            </div>
